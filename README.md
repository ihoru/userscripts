...
| Name | Description | Install <br/> Update | Version <br/> Updated |
| --- | --- | --- | --- |
| [Toggl Auto Favorites](toggl-auto-favorites/) | Opens Favorites and collapses expanded desktop navigation once per Timer visit. | [Install <br/> Update](https://ihoru.github.io/userscripts/toggl-auto-favorites/toggl-auto-favorites.user.js) | 1.0.0 <br/> 2026-09-10 |
| [DuoCards Auto Import](duocards-auto-import/) | Saves loaded import cards, resets duplicate progress, and logs completed actions. | [Install <br/> Update](https://ihoru.github.io/userscripts/duocards-auto-import/duocards-auto-import.user.js) | 1.1.2 <br/> 2026-09-09 |
| [GitLab → TopTracker](gitlab-toptracker/) | Adds a Start TopTracker link only on [git.psa-europe.com](https://git.psa-europe.com/); requires a separate desktop handler. See [handler setup](gitlab-toptracker/README.md#desktop-handler-setup-linux) and [other GitLab hosts](gitlab-toptracker/README.md#using-another-gitlab-instance-or-gitlabcom). | [Install <br/> Update](https://ihoru.github.io/userscripts/gitlab-toptracker/gitlab-toptracker.user.js) | 0.1.1 <br/> 2026-09-09 |
